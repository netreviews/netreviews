...
.av-list-star li{
	list-style-image : url(/modules/netreviews/img/single-star.png);
	margin-left: 15px;
	line-height: 25px;
	text-align: left;
}
...
<div id="avisverifies_module">
			...
			<table class="tg">
			  <tr>
			    <th class="tg-031e"><p>{l s='Verified Reviews is an innovative and independent solution that enables you to collect, moderate and publish your customer reviews. You will increase your credibility and visibility on the web towards new customers!' mod='netreviews'}</p>
					<p>{l s='We provide you with a solution that enables you to collect customer reviews about your website and products which will show on your website and on a certificate which will increase the credibility of published reviews.' mod='netreviews'}</p>
					<br>
	...
	<fieldset>
		...
		<div class='export'>
			<p>{l s='Export your recently received orders to collect immediately your first customer reviews and to show your certificate Verified Reviews.' mod='netreviews'}</p>
			<ul>
